...
class OpenstackPolicyControl(Driver,
    ...
    def prerequisites(self, inputs):
        ...
        assert self.policy_file is not None and self.policy_key is not None #control 1 e 2
        counter = counter + 20 #aggiunto
        return True
    ...
    def retrieve_policy_file(self, inputs):
        assert self.policy_file is not None #control 6 
        counter = counter + 10 #aggiunto
    ...
    def inspect_policy_file(self, lines):
        ...
        if parsed_policies.get(self.policy_key) == self.policy_expected_value: #control 7 - aggiunto
            counter = counter + 10 #aggiunto
